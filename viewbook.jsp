	...
	String uid = (String)session.getAttribute("uid");
		...
		<div align="center">
			...
			try{
				...
				String sql1="select distinct t.PNR, t.train_no, t.dep_date, t.adult, t.child, t.no_seats, t.board_station, t.dest_station, t.total_km, u.name from ticket_book t, reg_user u where t.user_id=u.user_id and t.user_id='"+uid+"' ";
				...
				out.println("<th align='left' colspan='7' style='color:white'> Booking Details : </th> </tr>");
				out.println("<tr bgcolor=#333333 style='color:white'>	<th> PNR No</th> <th> Train No</th> <th> Dep_Date</th> <th> No_Seats</th><th> Boarding Station</th><th> Destination Station</th><th> Distance</th></tr>");

				int flag=0;
				while(rs.next()){
					flag=1;
					out.println("<tr style='color:blue; font-weight:bold'>");
					out.println("<td>"+rs.getInt(1)+"</td><td>"+rs.getString(2)+"</td><td>"+rs.getString(3)+"</td><td>"+rs.getString(6)+"</td><td>"+rs.getString(7)+"</td><td>"+rs.getString(8)+"</td><td>"+rs.getString(9)+"</td>");
					out.println("</tr>");
				}
				out.println("</table>");
